...
public class volumeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.bt_0: f_op1.append("0");volume();break;
            case R.id.bt_1: f_op1.append("1");volume();break;
            case R.id.bt_2: f_op1.append("2");volume();break;
            case R.id.bt_3: f_op1.append("3");volume();break;
            case R.id.bt_4: f_op1.append("4");volume();break;
            case R.id.bt_5: f_op1.append("5");volume();break;
            case R.id.bt_6: f_op1.append("6");volume();break;
            case R.id.bt_7: f_op1.append("7");volume();break;
            case R.id.bt_8: f_op1.append("8");volume();break;
            case R.id.bt_9: f_op1.append("9");volume();break;
            case R.id.bt_point:if(f_op1.length()==0)f_op1.append("0");f_op1.append(".");break;
            case R.id.bt_AC:f_op1.setText("");volume();break;
            case R.id.bt_CE:
                if(f_op1.length()!=0){
